...
static unsigned int INPUT_BOOST_FREQ_PRIME = CONFIG_INPUT_BOOST_FREQ_PRIME;
...
static unsigned int MAX_BOOST_FREQ_PRIME = CONFIG_MAX_BOOST_FREQ_PRIME;
...
static unsigned int MIN_FREQ_PRIME = CONFIG_MIN_FREQ_PRIME;
