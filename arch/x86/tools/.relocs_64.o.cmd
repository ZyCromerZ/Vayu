cmd_arch/x86/tools/relocs_64.o := clang -Wp,-MD,arch/x86/tools/.relocs_64.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -std=gnu89 -pipe  -Wno-unused-value -Wno-unused-parameter -Wno-missing-field-initializers   -I./tools/include  -c -o arch/x86/tools/relocs_64.o arch/x86/tools/relocs_64.c
